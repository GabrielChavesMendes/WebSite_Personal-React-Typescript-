...
export function Contato() {
  ...
  const tojiRef = useRef<HTMLDivElement>(null);
  ...
  useGSAP(() => {
    ...
    // Formulário (Esquerda) deslizando de fora da tela
    tl.fromTo(leftColRef.current,
      { x: -100, opacity: 0 },
      { x: 0, opacity: 1, duration: 1, ease: "power3.out" }
    )
    
    // Sobre Mim (Direita) deslizando de fora da tela
  ...
  return (
    <section id="contatos" ref={containerRef} className="relative py-20 w-full z-20 bg-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* LADO ESQUERDO: Título + Formulário*/}
        <div ref={leftColRef} className="md:-translate-x-30">
            {/* TÍTULO */}
            ...
            <div ref={rightColRef} className="col-span-1 md:col-span-4 md:col-start-7 flex flex-col gap-8 text-center md:text-left md:pt-4 md:-translate-x-20">
      ...
      {/* TOJI ANIMADO */}
      <div ref={tojiRef} className="mt-16 md:mt-0 flex justify-center md:absolute md:bottom-0 md:right-0 z-0 pointer-events-none">
        <img 
            src={imgToji}
            alt="Personagem Toji"
