        ...
        <section 
            ...
            >
                ...
                <div className="mb-12 relative z-10">
                    <h2 className="text-[60px] md:text-[90px] font-black text-white tracking-widest leading-none">
                        QUEM
                    </h2>

                    <h2 className="text-[60px] md:text-[90px] font-blac texto-vazado tracking-widest leading-none mt[-20px] translate-x-10">
                        SOU EU
                    </h2>
                </div>

                {/* 2. Área do Conteúdo (3 colunas) */}
                <div className="flex flex-col md:flex-row items-center justify-btween gap-10 z-10">
                    
                    {/* Coluna 1: Personagem */}
                    <div className="w-full md:w-1/4 flex justify-center translate-y-20 relative">
                        ...
                        <img
                            src={imgToji}
                            alt="Personagem Toji"
                            className="w-full max-w-[250px] h-auto object-contain drop-shadow-[0_0_25px_rgba(147, 51, 234, 0.6)] relative z-10 opacity-80"
                        />
                    </div>

                    {/* Coluna 2: Texto Apresentação */}
                    <div className="w-full md:w-2/4 text-gray-200 text-lg md:text-xl leading-relaxed text-justify font-medium z-10">
                        <p>
                    ...
                    <div className="w-full md:w-1/4 flex justify-center relative -translate-y-30">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-purple-700/60 rounded-full blur-[100px] z-0 pointer-events-none"></div>    
                    
                        {/* Quadrado para a foto */}
                        <img 
                            src={imgPersonal}
