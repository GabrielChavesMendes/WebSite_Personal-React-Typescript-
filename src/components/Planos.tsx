...
export function Planos() {
  return (
    <section id="planos" className="relative py-20 w-full z-20">
      
      <div className="max-w-7xl mx-auto px-8 mb-8 flex justify-end">
        <h2 className="text-[60px] md:text-[90px] font-black texto-vazado tracking-widest leading-none mt-[-20px] translate-x-30">
          PLANOS
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1400px] mx-auto px-4 md:px-0">
        ...
        <div 
          className="relative p-8 md:p-12 flex justify-center items-center rounded-3xl overflow-hidden shadow-2xl"
          style={{ backgroundImage: `url(${bgBasic})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
          <div className="border-2 border-white rounded-[40px] p-8 flex flex-col items-center text-center bg-[#68276E]/40 backdrop-blur-sm w-full h-full">
            
            <div className="min-h-[220px] flex flex-col items-center justify-start w-full">
              <h3 className="text-white font-bold text-xl mb-6">PLANO BASIC: Restrição Celestial</h3>
              <img src={imgArma1} alt="Arma 1" className="w-28 h-30 mb-6 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
            </div>
        ...
        >
          <div className="border-2 border-white rounded-[40px] p-8 flex flex-col items-center text-center bg-[#121212]/40 backdrop-blur-sm w-full h-full">
            
            <div className="min-h-[220px] flex flex-col items-center justify-start w-full">
              <h3 className="text-white font-bold text-xl mb-6">PLANO PLUS: Caçador de Elite</h3>
              <img src={imgArma2} alt="Arma 2" className="w-28 h-28 mb-6 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
            </div>
        ...
        >
          <div className="border-2 border-white rounded-[40px] p-8 flex flex-col items-center text-center bg-[#68276E]/40 backdrop-blur-sm w-full h-full">
            ...
            <div className="min-h-[220px] flex flex-col items-center justify-start w-full">
              <h3 className="text-white font-bold text-xl mb-6 flex flex-col items-center">
                <span>PLANO PREMIUM: Assassino de</span>
                <span>Feiticeiros</span>
              </h3>
              <img src={imgToji} alt="Toji" className="w-24 h-24 mb-6 object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
            </div>
